...
public class DesconfirmarAgendaCommand implements Command{
	...
	public String execute(HttpServletRequest request, HttpServletResponse response)
		...
		System.out.print("horarioId[Desconfirmar]" + horarioId + "/n");
		
		try {
			AgendaService agendaService = new AgendaService();
			salvo = agendaService.confirmarAgenda(horarioId, false);
