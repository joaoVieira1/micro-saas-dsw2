...
@WebServlet("/imagens.do")
public class ImagemClientServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	
	private static final String IMAGEM_DIR = "C:\\IFSP\\5 Semestre\\DESENVOLVIMENTO WEB 2\\desenvolvimento web 2\\uploads";
