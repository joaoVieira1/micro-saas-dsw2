		...
		<c:forEach var="horario" items="${horarios}">
			<div class="card p-3">
				<div class="card-body">
					...
					<p class="card-text">
						Status: <span
							class="badge ${horario.status == 'DESOCUPADO' ? 'badge-success' : 'badge-danger'}">
							${horario.status} </span>
					</p>

					<a href="cliente.do?action=ocuparHorario&id=${horario.id}"
						class="btn btn-outline-primary">Ocupar Horário</a>
